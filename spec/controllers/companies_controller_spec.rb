  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created company" do
        post :create, company: FactoryGirl.attributes_for(:company)
        expect(response).to redirect_to(new_company_job_path(Company.last))
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested company" do
        put :update, id: @company, company: new_attributes
        @company.reload
        expect(@company.name).to eq("Wayne Enterprises")
      end
      ...
      it "redirects to the company" do
        put :update, id: @company, company: FactoryGirl.attributes_for(:company)
        expect(response).to redirect_to(home_company_path(@company))
      end
    end
